...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //var Beach = Beach("name", 0.0, 0.0, 0.0)

        mMap.addMarker(
            MarkerOptions().position(LatLng(55.4578631605276, 10.66580564769334)).title("Kerteminde Nordstrand").icon(
                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)
            ))
        mMap.addMarker(
            MarkerOptions().position(LatLng(55.559144842780235, 10.466831402854728)).title("Hasmark Strand").icon(
                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)
            ))
        mMap.addMarker(
            MarkerOptions().position(LatLng(55.37738690518388, 10.771233901499762)).title("Nordenhuse Strand").icon(
