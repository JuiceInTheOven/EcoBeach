...
def setUpSparkSession():
    spark = SparkSession.builder \
        ...
        .config('spark.sql.streaming.checkpointLocation', 'hdfs://namenode:9870/stream-checkpoint/') \
        .getOrCreate()
    spark.sparkContext.setCheckpointDir('hdfs://namenode:9870/udf-checkpoint/')
