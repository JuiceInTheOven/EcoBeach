...
def setUpSparkSession():
    spark = SparkSession.builder \
        ...
        .config('spark.sql.streaming.checkpointLocation', 'hdfs://135.181.80.186:9870/stream-checkpoint/') \
        .getOrCreate()
    spark.sparkContext.setCheckpointDir('hdfs://135.181.80.186:9870/udf-checkpoint/')
